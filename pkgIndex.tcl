...
package ifneeded MessagePrinter 1.0 [list source [file join $rivetweb_dir tcl message_printer.tcl]]
...
package ifneeded RWTemplate 2.0 [list source [file join $rivetweb_dir tcl rweb_template.tcl]]
