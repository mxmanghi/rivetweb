...
package ifneeded rwebdb 2.0 [list source [file join $rivetweb_dir tcl rweb_coredb.tcl]]
...
package ifneeded UrlHandler 1.0 [list source [file join $rivetweb_dir tcl datasource urlhandler.tcl]]
